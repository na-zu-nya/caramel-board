...
- `apps/desktop/src-tauri/target/release/bundle/dmg/Caramel Board_1.0.10-beta_aarch64.dmg`
...
1. root `package.json` の `version` を更新して `node scripts/sync-version.mjs` を実行する
