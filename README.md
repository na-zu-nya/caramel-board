...
- Windows向けのセットアップは [docs/installation-windows.md](./docs/installation-windows.md) を見てね 

- macOS/Linux向けのセットアップはこちら:

1. **以下のソフトを事前にインストールしてください**
...
start.sh でサービスが立ち上がります。(Windowsの場合、start.bat をダブルクリックでも起動します)
