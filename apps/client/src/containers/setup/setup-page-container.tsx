          ...
          <div className="relative mx-auto h-64 w-full max-w-md">
            ...
            <div className="relative flex h-full items-center justify-center">
              <div className="grid grid-cols-3 gap-4">
                <div
                  className="h-20 w-20 rounded-2xl bg-white shadow-xl flex items-center justify-center transform -rotate-6 hover:rotate-0 transition-transform">
                  <BookOpen className="h-10 w-10 text-purple-600"/>
                </div>
                <div
                  className="h-20 w-20 rounded-2xl bg-white shadow-xl flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform">
