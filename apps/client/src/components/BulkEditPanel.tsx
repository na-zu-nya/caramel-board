  ...
  return (
    <>
      ...
      <div
        ref={swipeRef}
        className={cn(
          'app-right-panel fixed top-14 bottom-0 right-0 w-80 overflow-hidden bg-white border-l border-gray-200 transform transition-transform duration-300 ease-in-out z-40 shadow-xl',
      ...
      >
        <div className="flex h-full min-h-0 flex-col">
          ...
          {/* Edit Content */}
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-4 space-y-6 bg-gray-50">
            {/* Add Tags */}
              ...
              {existingAuthors.length > 0 && (
                <div className="mt-2">
                  <p className="text-xs text-gray-500 mb-1">
                    {t.bulkEdit.authorsFromSelectedItems}
                  </p>
                  <div className="flex flex-wrap gap-1">
